...
| Required Programming Hardware, Cost, URL      | N/A      | found on the microcontroller's product page                                                               |
| Works with MPLabX?                            | Yes     | Required.  See [Microchip Development Tools](https://www.microchip.com/development-tools)                 |
| Works with Microchip Code Configurator?       | Y      | Can be validated in MPLabX.  Screenshot required.                                                         |
